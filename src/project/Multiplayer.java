...
public class Multiplayer extends JFrame implements KeyListener, MouseListener, ActionListener {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Multiplayer frame = new Multiplayer(playerID);
					frame.multiFrame.setVisible(true);
				} catch (Exception e) {
					e.printStackTrace();
				}
			}
	 ...
	 */
	  ...
	  * */
		int playStep(int[] play, int goal[]) {
			...
			p1.setTotalScore(correctIn);
			p2.setTotalScore(correctIn);
			return 0;
		}
	...
	public void initialize() {
		...
		JOptionPane.showMessageDialog(multiFrame, "First one to guess correctly, wins 1000 Gold coins! Good Luck!");
		...
		btnNewButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {	//when submit, call play function which calls the logic of the game
				...
				if (x == 1) {JOptionPane.showMessageDialog(multiFrame, "Winner!");
